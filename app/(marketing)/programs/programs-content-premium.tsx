...
/* ----------------------------------------------------------------------------
 * 4b. Tech Initiatives — free tools we build (Marigold + more coming)
 * ------------------------------------------------------------------------- */

function TechInitiativesSection() {
  return (
    <section className="relative bg-[#141413] py-24 sm:py-32 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          <Eyebrow light>New · Tech Initiatives</Eyebrow>
          <h2 className="mt-6 font-semibold text-white text-3xl sm:text-4xl lg:text-[2.75rem] leading-[1.12] tracking-tight">
            We don&rsquo;t just teach the tools.{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C9A84C] to-[#E8D48B]">
              We build them.
            </span>
          </h2>
